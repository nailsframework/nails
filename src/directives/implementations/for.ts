...
export class ForImplementation {
  ...
  private ensureSafeToAccess(element: HTMLElement): boolean {
    return element.parentElement !== null && element.parentElement.parentElement !== null;
  }
  private addToList(element: HTMLElement) {
    if (this.lastElement === null) {
      if (this.ensureSafeToAccess(element) && element.parentElement.parentElement instanceof HTMLSelectElement) {
        element.parentElement.parentElement.add(element as HTMLOptionElement);
      } else {
    ...
    if (this.ensureSafeToAccess(element) && element.parentElement.parentElement instanceof HTMLSelectElement) {
      element.parentElement.parentElement.add(this.lastElement as HTMLOptionElement);
    } else {
